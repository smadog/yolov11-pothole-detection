---
comments: true
description: Explore the ImageNette yolo_formatted_dataset, a subset of ImageNet with 10 classes for efficient training and evaluation of image classification models. Ideal for ML and CV projects.
keywords: ImageNette yolo_formatted_dataset, ImageNet subset, image classification, machine learning, deep learning, YOLO, Convolutional Neural Networks, ML yolo_formatted_dataset, education, training
---
