...
keywords: YOLO, image classification, yolo_formatted_dataset structure, CIFAR-10, Ultralytics, machine learning, training data, model evaluation
---
...
# Train the model
results = model.train(data="path/to/your/yolo_formatted_dataset", epochs=100, imgsz=640)
```
