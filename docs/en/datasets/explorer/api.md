---
comments: true
description: Explore the Ultralytics Explorer API for yolo_formatted_dataset exploration with SQL queries, vector similarity search, and semantic search. Learn installation and usage tips.
keywords: Ultralytics, Explorer API, yolo_formatted_dataset exploration, SQL queries, similarity search, semantic search, Python API, LanceDB, embeddings, data analysis
---
...
# Create embeddings for your yolo_formatted_dataset
