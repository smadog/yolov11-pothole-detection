---
comments: true
description: Discover the Dog-Pose yolo_formatted_dataset for pose detection. Featuring 6,773 training and 1,703 test images, it's a robust yolo_formatted_dataset for training YOLO11 models.
keywords: Dog-Pose, Ultralytics, pose detection yolo_formatted_dataset, YOLO11, machine learning, computer vision, training data
---
