---
comments: true
description: Explore Ultralytics Tiger-Pose yolo_formatted_dataset with 263 diverse images. Ideal for testing, training, and refining pose estimation algorithms.
keywords: Ultralytics, Tiger-Pose, yolo_formatted_dataset, pose estimation, YOLO11, training data, machine learning, neural networks
---
