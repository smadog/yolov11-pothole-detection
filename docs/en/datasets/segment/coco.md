---
comments: true
description: Explore the COCO-Seg yolo_formatted_dataset, an extension of COCO, with detailed segmentation annotations. Learn how to train YOLO models with COCO-Seg.
keywords: COCO-Seg, yolo_formatted_dataset, YOLO models, instance segmentation, object detection, COCO yolo_formatted_dataset, YOLO11, computer vision, Ultralytics, machine learning
---
