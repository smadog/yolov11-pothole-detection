...
keywords: computer vision, project planning, problem statement, measurable objectives, yolo_formatted_dataset preparation, model selection, YOLO11, Ultralytics
---
