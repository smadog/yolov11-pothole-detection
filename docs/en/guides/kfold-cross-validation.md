...
keywords: Ultralytics, YOLO, K-Fold Cross Validation, object detection, sklearn, pandas, PyYaml, machine learning, yolo_formatted_dataset split
---
...
2. Proceed to retrieve all label files for your dataset.
    ...
    dataset_path = Path("./Fruit-detection")  # replace with 'path/to/yolo_formatted_dataset' for your custom data
...
4. Next, we create the directories and dataset YAML files for each split.
    ...
    # Create the necessary directories and yolo_formatted_dataset YAML files
    ...
    for split in folds_df.columns:
        ...
        # Create yolo_formatted_dataset YAML files
...
3. You can also use [Ultralytics data.utils.autosplit](https://docs.ultralytics.com/reference/data/utils/) function for automatic dataset splitting:
    ...
    # Automatically split yolo_formatted_dataset into train/val/test
