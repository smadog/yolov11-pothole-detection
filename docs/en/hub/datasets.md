...
keywords: Ultralytics HUB, datasets, custom datasets, yolo_formatted_dataset management, model training, upload datasets, share datasets, yolo_formatted_dataset workflow
---
...
check_dataset("path/to/yolo_formatted_dataset.zip", task="detect")
```
