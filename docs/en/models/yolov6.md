...
keywords: Meituan YOLOv6, object detection, real-time applications, BiC module, Anchor-Aided Training, COCO yolo_formatted_dataset, high-performance models, Ultralytics Docs
---
