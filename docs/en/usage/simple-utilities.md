...
keywords: Ultralytics, utilities, data processing, auto annotation, YOLO, yolo_formatted_dataset conversion, bounding boxes, image compression, machine learning tools
---
...
# The classes here is the total classes in the yolo_formatted_dataset.
# for COCO yolo_formatted_dataset we have 80 classes.
