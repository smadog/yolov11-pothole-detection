...
```bash
# Train a YOLOv5 model on your yolo_formatted_dataset (e.g., yolov5s)
...
4.  Begin the [training process](../../modes/train.md) using your custom dataset YAML and potentially starting from pre-trained weights:
    ...
    ```bash
    # Example: Train YOLOv5s on a custom yolo_formatted_dataset for 100 epochs
...
# Example: Copy your yolo_formatted_dataset from a GCS bucket to your VM
