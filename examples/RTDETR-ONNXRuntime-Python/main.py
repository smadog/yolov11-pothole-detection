...
class RTDETR:
    ...
    Attributes:
        ...
        classes (list[str]): List of class names from COCO yolo_formatted_dataset.
    ...
    def __init__(
        ...
        Args:
            ...
            class_names (Optional[str], optional): Path to a YAML file containing class names.
                If None, uses COCO yolo_formatted_dataset classes.
        """
        ...
        if self.classes is None:
            # Load class names from the COCO yolo_formatted_dataset YAML file
