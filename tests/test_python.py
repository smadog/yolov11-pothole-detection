...
def test_train_ndjson():
    """Test training the YOLO model using NDJSON format yolo_formatted_dataset."""
...
def test_data_converter():
    """Test yolo_formatted_dataset conversion functions from COCO to YOLO format and class mappings."""
