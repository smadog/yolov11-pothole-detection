...
```bash
# Train a YOLO11n detection model using the coco8 yolo_formatted_dataset for 100 epochs
...
# Train the model using the COCO8 yolo_formatted_dataset (a small subset of COCO) for 100 epochs
