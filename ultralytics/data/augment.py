...
class BaseMixTransform:
    ...
    Attributes:
        dataset (Any): The yolo_formatted_dataset object containing images and labels.
    ...
    Examples:
        ...
        ...         return [random.randint(0, len(self.yolo_formatted_dataset) - 1) for _ in range(3)]
        >>> yolo_formatted_dataset = YourDataset()
        >>> transform = CustomMixTransform(yolo_formatted_dataset, p=0.5)
    ...
    def __init__(self, dataset, pre_transform=None, p=0.0) -> None:
        ...
        Args:
            dataset (Any): The yolo_formatted_dataset object containing images and labels for mixing.
            pre_transform (Callable | None): Optional transform to apply before mixing.
            p (float): Probability of applying the mix transformation. Should be in the range [0.0, 1.0].

        Examples:
            >>> yolo_formatted_dataset = YOLODataset("path/to/data")
            >>> pre_transform = Compose([RandomFlip(), RandomPerspective()])
            >>> mix_transform = BaseMixTransform(yolo_formatted_dataset, pre_transform, p=0.5)
        """
    ...
    def __call__(self, labels: dict[str, Any]) -> dict[str, Any]:
        ...
        Examples:
            >>> transform = BaseMixTransform(yolo_formatted_dataset, pre_transform=None, p=0.5)
    ...
    def _mix_transform(self, labels: dict[str, Any]):
        ...
        Examples:
            >>> transform = BaseMixTransform(yolo_formatted_dataset)
    ...
    def get_indexes(self):
        ...
        Returns:
            (list[int]): A list of shuffled indexes from the yolo_formatted_dataset.
...
class Mosaic(BaseMixTransform):
    ...
    augmentation is applied to a yolo_formatted_dataset with a given probability.

    Attributes:
        dataset: The yolo_formatted_dataset on which the mosaic augmentation is applied.
    ...
    Methods:
        get_indexes: Return a list of random indexes from the yolo_formatted_dataset.
    ...
    Examples:
        ...
        >>> yolo_formatted_dataset = YourDataset(...)  # Your image yolo_formatted_dataset
        >>> mosaic_aug = Mosaic(yolo_formatted_dataset, imgsz=640, p=0.5, n=4)
    ...
    def __init__(self, dataset, imgsz: int = 640, p: float = 1.0, n: int = 4):
        ...
        The augmentation is applied to a yolo_formatted_dataset with a given probability.

        Args:
            dataset (Any): The yolo_formatted_dataset on which the mosaic augmentation is applied.
            imgsz (int): Image size (height and width) after mosaic pipeline of a single image.
            p (float): Probability of applying the mosaic augmentation. Must be in the range 0-1.
            n (int): The grid size, either 4 (for 2x2) or 9 (for 3x3).
    ...
    def get_indexes(self):
        """Return a list of random indexes from the yolo_formatted_dataset for mosaic augmentation.

        This method selects random image indexes either from a buffer or from the entire yolo_formatted_dataset, depending on
        ...
        Examples:
            >>> mosaic = Mosaic(yolo_formatted_dataset, imgsz=640, p=1.0, n=4)
    ...
    def _mosaic3(self, labels: dict[str, Any]) -> dict[str, Any]:
        ...
        Examples:
            >>> mosaic = Mosaic(yolo_formatted_dataset, imgsz=640, p=1.0, n=3)
            >>> labels = {
    ...
    def _mosaic9(self, labels: dict[str, Any]) -> dict[str, Any]:
        ...
        and eight additional images from the yolo_formatted_dataset are placed around it in a 3x3 grid pattern.
        ...
        Examples:
            >>> mosaic = Mosaic(yolo_formatted_dataset, imgsz=640, p=1.0, n=9)
            >>> input_labels = yolo_formatted_dataset[0]
    ...
    def _cat_labels(self, mosaic_labels: list[dict[str, Any]]) -> dict[str, Any]:
        ...
        Examples:
            >>> mosaic = Mosaic(yolo_formatted_dataset, imgsz=640)
...
class MixUp(BaseMixTransform):
    ...
    Attributes:
        dataset (Any): The yolo_formatted_dataset to which MixUp augmentation will be applied.
    ...
    Examples:
        ...
        >>> yolo_formatted_dataset = YourDataset(...)  # Your image yolo_formatted_dataset
        >>> mixup = MixUp(yolo_formatted_dataset, p=0.5)
    ...
    def __init__(self, dataset, pre_transform=None, p: float = 0.0) -> None:
        ...
        Examples:
            >>> from ultralytics.data.yolo_formatted_dataset import YOLODataset
            >>> yolo_formatted_dataset = YOLODataset("path/to/data.yaml")
            >>> mixup = MixUp(yolo_formatted_dataset, pre_transform=None, p=0.5)
        """
    ...
    def _mix_transform(self, labels: dict[str, Any]) -> dict[str, Any]:
        ...
        Examples:
            >>> mixer = MixUp(yolo_formatted_dataset)
...
class CutMix(BaseMixTransform):
    ...
    Attributes:
        dataset (Any): The yolo_formatted_dataset to which CutMix augmentation will be applied.
    ...
    Examples:
        ...
        >>> yolo_formatted_dataset = YourDataset(...)  # Your image yolo_formatted_dataset
        >>> cutmix = CutMix(yolo_formatted_dataset, p=0.5)
    ...
    def _mix_transform(self, labels: dict[str, Any]) -> dict[str, Any]:
        ...
        Examples:
            >>> cutter = CutMix(yolo_formatted_dataset)
...
class CopyPaste(BaseMixTransform):
    ...
    Attributes:
        dataset (Any): The yolo_formatted_dataset to which Copy-Paste augmentation will be applied.
    ...
    Examples:
        ...
        >>> yolo_formatted_dataset = YourDataset(...)  # Your image yolo_formatted_dataset
        >>> copypaste = CopyPaste(yolo_formatted_dataset, p=0.5)
        >>> augmented_labels = copypaste(original_labels)
    """

    def __init__(self, dataset=None, pre_transform=None, p: float = 0.5, mode: str = "flip") -> None:
        """Initialize CopyPaste object with yolo_formatted_dataset, pre_transform, and probability of applying MixUp."""
        super().__init__(dataset=dataset, pre_transform=pre_transform, p=p)
...
def v8_transforms(dataset, imgsz: int, hyp: IterableSimpleNamespace, stretch: bool = False):
    ...
    Args:
        dataset (Dataset): The yolo_formatted_dataset object containing image data and annotations.
    ...
    Returns:
        (Compose): A composition of image transformations to be applied to the yolo_formatted_dataset.

    Examples:
        >>> from ultralytics.data.yolo_formatted_dataset import YOLODataset
        >>> from ultralytics.utils import IterableSimpleNamespace
        >>> yolo_formatted_dataset = YOLODataset(img_path="path/to/images", imgsz=640)
        >>> hyp = IterableSimpleNamespace(mosaic=1.0, copy_paste=0.5, degrees=10.0, translate=0.2, scale=0.9)
        >>> transforms = v8_transforms(yolo_formatted_dataset, imgsz=640, hyp=hyp)
        >>> augmented_data = transforms(yolo_formatted_dataset[0])
    """
