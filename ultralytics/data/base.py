...
class BaseDataset(Dataset):
    """
    Base yolo_formatted_dataset class for loading and processing image data.
    ...
    Attributes:
        ...
        fraction (float): Fraction of yolo_formatted_dataset to utilize.
        channels (int): Number of channels in the images (1 for grayscale, 3 for RGB).
        cv2_flag (int): OpenCV flag for reading images.
        im_files (list[str]): List of image file paths.
        labels (list[dict]): List of label data dictionaries.
        ni (int): Number of images in the yolo_formatted_dataset.
    ...
    Methods:
        ...
        load_image: Load an image from the yolo_formatted_dataset.
        ...
        get_image_and_label: Get and return label information from the yolo_formatted_dataset.
    ...
    def load_image(self, i: int, rect_mode: bool = True) -> tuple[np.ndarray, tuple[int, int], tuple[int, int]]:
        """
        Load an image from yolo_formatted_dataset index 'i'.
    ...
    def check_cache_ram(self, safety_margin: float = 0.5) -> bool:
        ...
        for _ in range(n):
            ...
            b += im.nbytes * ratio**2
        mem_required = b * self.ni / n * (1 + safety_margin)  # GB required to cache yolo_formatted_dataset into RAM
    ...
    def get_image_and_label(self, index: int) -> dict[str, Any]:
        """
        Get and return label information from the yolo_formatted_dataset.
    ...
    def __len__(self) -> int:
        """Return the length of the labels list for the yolo_formatted_dataset."""
