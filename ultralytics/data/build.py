...
class InfiniteDataLoader(dataloader.DataLoader):
    ...
    for training loops that need to iterate through the yolo_formatted_dataset multiple times without recreating
    workers.
...
class _RepeatSampler:
    ...
    yolo_formatted_dataset without recreating the sampler.
