...
def convert_dota_to_yolo_obb(dota_root_path: str):
    ...
    The function processes images in the 'train' and 'val' folders of the DOTA yolo_formatted_dataset. For each image, it reads the
...
def create_synthetic_coco_dataset():
    ...
    them in the COCO yolo_formatted_dataset structure. It uses multithreading to generate images efficiently.
