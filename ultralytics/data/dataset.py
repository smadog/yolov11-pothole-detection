...
class GroundingDataset(YOLODataset):
    ...
    This yolo_formatted_dataset is designed for grounding tasks where annotations are provided in a JSON file rather than
    ...
    def verify_labels(self, labels: list[dict[str, Any]]) -> None:
        ...
        Args:
            labels (list[dict[str, Any]]): List of label dictionaries, where each dictionary
                contains yolo_formatted_dataset annotations. Each label dict must have a 'bboxes' key with
        ...
        Raises:
            AssertionError: If the actual instance count doesn't match the expected count
                for a recognized yolo_formatted_dataset.
...
class ClassificationDataset:
    ...
    def __init__(self, root: str, args, augment: bool = False, prefix: str = ""):
        ...
        Args:
            ...
            args (Namespace): Configuration containing yolo_formatted_dataset-related settings such as image size, augmentation
                parameters, and cache settings.
            augment (bool, optional): Whether to apply augmentations to the yolo_formatted_dataset.
            prefix (str, optional): Prefix for logging and cache filenames, aiding in yolo_formatted_dataset identification.
        """
