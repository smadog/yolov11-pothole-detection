...
def split_classify_dataset(source_dir: str | Path, train_ratio: float = 0.8) -> Path:
    """
    Split classification yolo_formatted_dataset into train and val directories in a new directory.
    ...
    Args:
        source_dir (str | Path): Path to classification yolo_formatted_dataset root directory.
    ...
    Examples:
        Split yolo_formatted_dataset with default 80/20 ratio
