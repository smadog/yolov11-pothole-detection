...
def load_yolo_dota(data_root: str, split: str = "train") -> list[dict[str, Any]]:
    """
    Load DOTA yolo_formatted_dataset annotations and image information.
...
def split_images_and_labels(
    ...
    """
    Split both images and labels for a given yolo_formatted_dataset split.

    Args:
        data_root (str): Root directory of the yolo_formatted_dataset.
        save_dir (str): Directory to save the split yolo_formatted_dataset.
        split (str, optional): The split data set, could be 'train' or 'val'.
...
def split_trainval(
    ...
    """
    Split train and val sets of DOTA yolo_formatted_dataset with multiple scaling rates.
...
def split_test(
    ...
    """
    Split test set of DOTA yolo_formatted_dataset, labels are not included within this set.
