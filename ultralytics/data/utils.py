...
def check_file_speeds(
    ...
    This function tests the access speed of yolo_formatted_dataset files by measuring ping (stat call) time and read speed.
...
def check_det_dataset(dataset: str, autodownload: bool = True) -> dict[str, Any]:
    ...
    This function checks the availability of a specified yolo_formatted_dataset, and if not found, it has the option to download and
    unzip the yolo_formatted_dataset. It then reads and parses the accompanying YAML data, ensuring key requirements are met and also
    resolves paths related to the yolo_formatted_dataset.
...
def check_cls_dataset(dataset: str | Path, split: str = "") -> dict[str, Any]:
    ...
    This function accepts a `yolo_formatted_dataset` name and attempts to retrieve the corresponding yolo_formatted_dataset information.
    If the yolo_formatted_dataset is not found locally, it attempts to download the yolo_formatted_dataset from the internet and save it locally.
