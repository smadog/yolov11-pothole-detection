...
class Model(torch.nn.Module):
    ...
    Methods:
        ...
        val: Validate the model on a yolo_formatted_dataset.
        benchmark: Benchmark the model on various export formats.
        export: Export the model to different formats.
        train: Train the model on a yolo_formatted_dataset.
    ...
    def val(
        ...
        **kwargs: Any,
        ...
        """
        Validate the model using a specified yolo_formatted_dataset and validation configuration.
    ...
    def benchmark(self, data=None, format="", verbose=False, **kwargs: Any):
        ...
        Args:
            data (str): Path to the yolo_formatted_dataset for benchmarking.
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        """
        Train the model using the specified yolo_formatted_dataset and training configuration.
        ...
        Args:
            ...
            **kwargs (Any): Arbitrary keyword arguments for training configuration. Common options include:
                data (str): Path to yolo_formatted_dataset configuration file.
