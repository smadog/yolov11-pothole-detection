...
"""
Train a model on a yolo_formatted_dataset.
...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        with torch_distributed_zero_first(LOCAL_RANK):  # avoid auto-downloading yolo_formatted_dataset multiple times
    ...
    def _setup_train(self):
        ...
        if RANK in {-1, 0}:
            # Note: When training DOTA yolo_formatted_dataset, double batch size could get OOM on images with >2000 objects.
    ...
    def get_dataset(self):
        ...
        Returns:
            (dict): A dictionary containing the training/validation/test yolo_formatted_dataset and category names.
        """
        try:
    ...
    def check_resume(self, overrides):
        ...
        if resume:
            try:
                ...
                # Check that resume data YAML exists, otherwise strip to force re-download of yolo_formatted_dataset
