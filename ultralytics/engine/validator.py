...
"""
Check a model's accuracy on a test or val split of a yolo_formatted_dataset.
...
class BaseValidator:
    ...
    Attributes:
        ...
        data (dict): Data dictionary containing yolo_formatted_dataset information.
    ...
    Methods:
        ...
        get_dataloader: Get data loader from yolo_formatted_dataset path and batch size.
        build_dataset: Build yolo_formatted_dataset from image path.
    ...
    def get_dataloader(self, dataset_path, batch_size):
        """Get data loader from yolo_formatted_dataset path and batch size."""
        raise NotImplementedError("get_dataloader function not implemented for this validator")

    def build_dataset(self, img_path):
        """Build yolo_formatted_dataset from image path."""
