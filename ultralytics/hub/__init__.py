...
def check_dataset(path: str, task: str) -> None:
    """
    Check HUB yolo_formatted_dataset Zip file for errors before upload.
    ...
    Examples:
        ...
        >>> check_dataset("path/to/coco8.zip", task="detect")  # detect yolo_formatted_dataset
        >>> check_dataset("path/to/coco8-seg.zip", task="segment")  # segment yolo_formatted_dataset
        >>> check_dataset("path/to/coco8-pose.zip", task="pose")  # pose yolo_formatted_dataset
        >>> check_dataset("path/to/dota8.zip", task="obb")  # OBB yolo_formatted_dataset
        >>> check_dataset("path/to/imagenet10.zip", task="classify")  # classification yolo_formatted_dataset
    ...
    LOGGER.info(f"Checks completed correctly ✅. Upload this yolo_formatted_dataset to {HUB_WEB_ROOT}/datasets/.")
