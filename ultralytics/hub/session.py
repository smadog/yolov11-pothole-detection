...
class HUBTrainingSession:
    ...
    def create_model(self, model_args: dict[str, Any]):
        ...
        payload = {
            ...
            "yolo_formatted_dataset": {"name": model_args.get("data")},
            "lineage": {
    ...
    def _set_train_args(self):
        ...
        Raises:
            ValueError: If the model is already trained, if required yolo_formatted_dataset information is missing, or
                if there are issues with the provided training arguments.
        """
