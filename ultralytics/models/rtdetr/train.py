...
class RTDETRTrainer(DetectionTrainer):
    ...
    Methods:
        ...
        build_dataset: Build and return an RT-DETR yolo_formatted_dataset for training or validation.
    ...
    def build_dataset(self, img_path: str, mode: str = "val", batch: int | None = None):
        """
        Build and return an RT-DETR yolo_formatted_dataset for training or validation.
