...
and has been trained on the SA-1B yolo_formatted_dataset. It features zero-shot performance capabilities, enabling it to adapt to new
...
Key Features:
    ...
    - Trained on SA-1B yolo_formatted_dataset
"""
