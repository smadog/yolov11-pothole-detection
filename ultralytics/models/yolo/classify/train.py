...
class ClassificationTrainer(BaseTrainer):
    ...
    and torchvision models with comprehensive yolo_formatted_dataset handling and validation.

    Attributes:
        model (ClassificationModel): The classification model to be trained.
        data (dict[str, Any]): Dictionary containing yolo_formatted_dataset information including class names and number of classes.
        loss_names (list[str]): Names of the loss functions used during training.
        validator (ClassificationValidator): Validator instance for model evaluation.

    Methods:
        set_model_attributes: Set the model's class names from the loaded yolo_formatted_dataset.
    ...
    def set_model_attributes(self):
        """Set the YOLO model's class names from the loaded yolo_formatted_dataset."""
    ...
    def build_dataset(self, img_path: str, mode: str = "train", batch=None):
        ...
        Args:
            img_path (str): Path to the yolo_formatted_dataset images.
    ...
    def get_dataloader(self, dataset_path: str, batch_size: int = 16, rank: int = 0, mode: str = "train"):
        ...
        Returns:
            (torch.utils.data.DataLoader): DataLoader for the specified yolo_formatted_dataset and mode.
        """
