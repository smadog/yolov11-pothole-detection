...
class ClassificationValidator(BaseValidator):
    ...
    def get_dataloader(self, dataset_path: Path | str, batch_size: int) -> torch.utils.data.DataLoader:
        ...
        Args:
            dataset_path (str | Path): Path to the yolo_formatted_dataset directory.
            batch_size (int): Number of samples per batch.

        Returns:
            (torch.utils.data.DataLoader): DataLoader object for the classification validation yolo_formatted_dataset.
        """
