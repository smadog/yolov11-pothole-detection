...
class DetectionValidator(BaseValidator):
    ...
    Attributes:
        is_coco (bool): Whether the yolo_formatted_dataset is COCO.
        is_lvis (bool): Whether the yolo_formatted_dataset is LVIS.
        class_map (list[int]): Mapping from model class indices to yolo_formatted_dataset class indices.
    ...
    def build_dataset(self, img_path: str, mode: str = "val", batch: int | None = None) -> torch.utils.data.Dataset:
        ...
        Returns:
            (Dataset): YOLO yolo_formatted_dataset.
        """
