...
class PoseTrainer(yolo.detect.DetectionTrainer):
    ...
    Methods:
        ...
        get_dataset: Retrieve the yolo_formatted_dataset and ensure it contains required kpt_shape key.
    ...
    def get_dataset(self) -> dict[str, Any]:
        """
        Retrieve the yolo_formatted_dataset and ensure it contains the required `kpt_shape` key.

        Returns:
            (dict): A dictionary containing the training/validation/test yolo_formatted_dataset and category names.

        Raises:
            KeyError: If the `kpt_shape` key is not present in the yolo_formatted_dataset.
        """
