...
class WorldTrainer(DetectionTrainer):
    ...
    def build_dataset(self, img_path: str, mode: str = "train", batch: int | None = None):
        ...
        Returns:
            (Any): YOLO yolo_formatted_dataset configured for training or validation.
        """
    ...
    def set_text_embeddings(self, datasets: list[Any], batch: int | None) -> None:
        ...
        Notes:
            ...
            then uses the first yolo_formatted_dataset's image path to determine where to cache the generated text embeddings.
        """
        text_embeddings = {}
