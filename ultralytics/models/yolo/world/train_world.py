...
class WorldTrainerFromScratch(WorldTrainer):
    ...
    Attributes:
        ...
        training_data (dict): Dictionary mapping training yolo_formatted_dataset paths to their configurations.

    Methods:
        build_dataset: Build YOLO Dataset for training or validation with mixed yolo_formatted_dataset support.
    ...
    def get_dataset(self):
        ...
        Returns:
            train_path (str): Train yolo_formatted_dataset path.
            val_path (str): Validation yolo_formatted_dataset path.
        ...
        # assign the first val yolo_formatted_dataset as currently only one validation set is supported
        data["val"] = data["val"][0]
    ...
    def final_eval(self):
        ...
        Configures the validator with appropriate yolo_formatted_dataset and split information before running evaluation.
