...
class YOLOETrainer(DetectionTrainer):
    ...
    model initialization, validation, and yolo_formatted_dataset building with multi-modal support.
...
class YOLOEVPTrainer(YOLOETrainerFromScratch):
    ...
    def build_dataset(self, img_path: list[str] | str, mode: str = "train", batch: int | None = None):
        ...
        Returns:
            (Dataset): YOLO yolo_formatted_dataset configured for training or validation, with visual prompts for
                training mode.
        """
