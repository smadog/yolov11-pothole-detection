...
class YOLOETrainer(DetectionTrainer):
    ...
    including custom model initialization, validation, and yolo_formatted_dataset building with multi-modal support.
    ...
    Methods:
        ...
        build_dataset: Build YOLO yolo_formatted_dataset with multi-modal support for training.
    """
    ...
    def build_dataset(self, img_path: str, mode: str = "train", batch: int | None = None):
        ...
        Returns:
            (Dataset): YOLO yolo_formatted_dataset configured for training or validation.
        """
...
class YOLOETrainerFromScratch(YOLOETrainer, WorldTrainerFromScratch):
    ...
    def build_dataset(self, img_path: list[str] | str, mode: str = "train", batch: int | None = None):
        ...
        Returns:
            (YOLOConcatDataset | Dataset): The constructed yolo_formatted_dataset for training or validation.
        """
...
class YOLOEPEFreeTrainer(YOLOEPETrainer, YOLOETrainerFromScratch):
    ...
    def set_text_embeddings(self, datasets, batch: int):
        ...
        in the parent directory of the first yolo_formatted_dataset's image path.
...
class YOLOEVPTrainer(YOLOETrainerFromScratch):
    ...
    Methods:
        build_dataset: Build yolo_formatted_dataset with visual prompt loading transforms.
    ...
    def build_dataset(self, img_path: list[str] | str, mode: str = "train", batch: int | None = None):
        ...
        Returns:
            (Dataset): YOLO yolo_formatted_dataset configured for training or validation, with visual prompts for training mode.
        """
    ...
    def _close_dataloader_mosaic(self):
        """Close mosaic augmentation and add visual prompt loading to the training yolo_formatted_dataset."""
