...
def benchmark(
    ...
    **kwargs,
    ...
    data = data or TASK2DATA[model.task]  # task to yolo_formatted_dataset, i.e. coco8.yaml for task=detect
...
class RF100Benchmark:
    ...
    This class provides functionality to benchmark YOLO models on the RF100 yolo_formatted_dataset collection.

    Attributes:
        ds_names (list[str]): Names of datasets used for benchmarking.
        ds_cfg_list (list[Path]): List of paths to yolo_formatted_dataset configuration files.
    ...
    Methods:
        ...
        parse_dataset: Parse yolo_formatted_dataset links and download datasets.
    ...
    def parse_dataset(self, ds_link_txt: str = "datasets_links.txt"):
        """
        Parse yolo_formatted_dataset links and download datasets.

        Args:
            ds_link_txt (str): Path to the file containing yolo_formatted_dataset links.

        Returns:
            ds_names (list[str]): List of yolo_formatted_dataset names.
            ds_cfg_list (list[Path]): List of paths to yolo_formatted_dataset configuration files.
    ...
    def evaluate(self, yaml_path: str, val_log_file: str, eval_log_file: str, list_ind: int):
        ...
        Args:
            ...
            list_ind (int): Index of the current yolo_formatted_dataset in the list.

        Returns:
            (float): The mean average precision (mAP) value for the evaluated model.

        Examples:
            Evaluate a model on a specific yolo_formatted_dataset
            >>> benchmark = RF100Benchmark()
