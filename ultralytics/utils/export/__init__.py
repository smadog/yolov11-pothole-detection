...
def onnx2engine(
    ...
    Notes:
        ...
        INT8 calibration requires a yolo_formatted_dataset and generates a calibration cache.
    ...
    if int8:
        ...
        class EngineCalibrator(trt.IInt8Calibrator):
            ...
            using a yolo_formatted_dataset. It handles batch generation, caching, and calibration algorithm selection.

            Attributes:
                dataset: Dataset for calibration.
                data_iter: Iterator over the calibration yolo_formatted_dataset.
            ...
            def __init__(
                ...
                """Initialize the INT8 calibrator with yolo_formatted_dataset and cache path."""
        ...
        # Load yolo_formatted_dataset w/ builder (for batching) and calibrate
